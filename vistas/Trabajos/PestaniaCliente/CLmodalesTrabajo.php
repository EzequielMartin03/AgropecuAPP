    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formModificarTrabajo<?= $Trabajo->IdTrabajo ?>" method="POST" action="?c=trabajo&a=Modificar" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="ClienteSelect<?= $Trabajo->IdTrabajo ?>" name="ClienteSelect" class="form-select" required>
                            <?php foreach ($clientes as $cliente): ?>
                                <option value="<?= $cliente->IdCliente ?>" <?= ($cliente->IdCliente == $Trabajo->IdCliente) ? 'selected' : '' ?>>
                                    <?= $cliente->Nombre ?> (ID: <?= $cliente->IdCliente ?>)
                                </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="mySelect4<?= $Trabajo->IdTrabajo ?>" name="aguatero[]" multiple="multiple" class="form-select select2" required>
                        ...
                        <div id="invalidAguatero<?= $Trabajo->IdTrabajo ?>" class="invalid-feedback">Seleccione al menos un aguatero.</div>
                    </div>

                    <!-- Campo Fumigador -->
                    <div class="mb-3">
                        <label for="mySelect5<?= $Trabajo->IdTrabajo ?>" class="form-label">Fumigador</label>
                        <select id="mySelect5<?= $Trabajo->IdTrabajo ?>" name="fumigador[]" multiple="multiple" class="form-select select2" required>
                        ...
                        <div id="invalidFumigador<?= $Trabajo->IdTrabajo ?>" class="invalid-feedback">Seleccione al menos un fumigador.</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="invalidDescripcion<?= $Trabajo->IdTrabajo ?>" class="invalid-feedback">Ingrese una descripción válida.</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="invalidCantidadHectareas<?= $Trabajo->IdTrabajo ?>" class="invalid-feedback">Ingrese una cantidad de hectáreas válida.</div>
                    </div>

                    <!-- Número de Factura -->
                    <div class="mb-3">
                        <label for="NroFactura<?= $Trabajo->IdTrabajo ?>" class="form-label">Número de Factura</label>
                        <input type="number" class="form-control" id="NroFactura<?= $Trabajo->IdTrabajo ?>" name="NroFactura" value="<?= $Trabajo->NroFactura ?>" required>
                        <div id="invalidNroFactura<?= $Trabajo->IdTrabajo ?>" class="invalid-feedback">Ingrese un número de factura válido.</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="invalidFechaTrabajo<?= $Trabajo->IdTrabajo ?>" class="invalid-feedback">Ingrese una fecha de trabajo válida.</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="invalidFechaPago<?= $Trabajo->IdTrabajo ?>" class="invalid-feedback">Ingrese una fecha de pago válida.</div>
                    </div>
